...
const [wallets, setWallets] = useState([
  ...
  return (
    <div className="p-6 bg-[#000000] min-h-screen">
      ...
      <div className="mt-12">
        <p className="text-white text-2xl font-semibold mb-4">Wallet Management</p>
          ...
          {wallets.map((wallet) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-y-1">
                ...
                <p className="text-sm text-white text-right">{wallet.id}</p>
                ...
                <p className="text-sm text-white text-right">{wallet.worth}</p>
