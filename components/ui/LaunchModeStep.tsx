      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-semibold text-sm mb-1">Launch Only Dev</h3>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-semibold text-sm mb-1">Launch + Snipe</h3>
            <p className="text-[#6A7A8C] text-sm break-words">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-semibold text-sm mb-1">Launch + Bundle + Snipe</h3>
            <p className="text-[#6A7A8C] text-sm break-words">
        ...
        {/* Risk Mode */}
        <div className="flex items-center justify-between gap-4 rounded-md p-4 cursor-pointer hover:bg-[#101217] flex-wrap sm:flex-nowrap">
          <div className="flex justify-center items-center bg-[#101217] border border-[#22242D] rounded-sm w-11 h-11 shrink-0">
            <Image src="/assets/refresh.svg" width={20} height={20} alt="Refresh" />
          </div>
          <div className="flex-1 min-w-0">
