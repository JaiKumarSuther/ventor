    ...
    <div className="fixed bottom-0 left-0 right-0 h-12 sm:h-14 w-full bg-[#0A0B0F] border-t border-[#0D0E12] flex justify-between items-center px-3 sm:px-4 lg:px-10 py-2 sm:py-3 text-[#B4B4B4] text-xs z-50">
      ...
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-5 text-white flex-shrink-0">
        <div className="flex items-center gap-1.5 sm:gap-2 rounded-full border border-[#22242D] px-2 sm:px-3 py-1.5 sm:py-2">
          <div className="flex items-center gap-1">
            <Image src="/assets/wallet.svg" width={14} height={14} alt="wallet" className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            <span className="text-xs sm:text-sm">5</span>
          </div>
          <div className="flex items-center gap-1">
            <Image src="/assets/salona.svg" width={14} height={14} alt="salona" className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
        ...
        <div className="items-center gap-1 hidden md:flex">
          <Image src="/assets/pnl-tracker.svg" width={16} height={16} alt="PnL Tracker" className="w-4 h-4" />
        ...
        <div className="items-center gap-1 hidden lg:flex">
          <Image src="/assets/salona.svg" width={16} height={16} alt="salona" className="w-4 h-4" />
      ...
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-5 text-white flex-1 justify-center min-w-0">
        ...
        <div className="hidden lg:flex items-center gap-5">
          {[
            ...
            <div key={index} className="flex items-center gap-1">
              <Image src={item.src} width={16} height={16} alt={item.label} className="w-4 h-4" />
        ...
        <div className="hidden md:flex lg:hidden items-center gap-3">
          <div className="flex items-center gap-1">
            <Image src="/assets/chain.svg" width={16} height={16} alt="chain" className="w-4 h-4" />
            <span className="text-xs">$312.52</span>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-5 text-white flex-shrink-0">
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Image src="/assets/notification.svg" width={16} height={16} alt="notification" className="w-4 h-4 sm:w-5 sm:h-5 cursor-pointer" />
          <Image src="/assets/X.svg" width={16} height={16} alt="X" className="w-4 h-4 sm:w-5 sm:h-5 cursor-pointer hidden sm:inline" />
          <Image src="/assets/docs.svg" width={16} height={16} alt="docs" className="w-4 h-4 sm:w-5 sm:h-5 cursor-pointer hidden md:inline" />
